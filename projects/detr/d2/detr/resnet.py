...
__all__ = [
    ...
    "ResNet",
    "make_stage",
    "build_two_stem_resnet_backbone",
]
...
class ResNet(Backbone):
    ...
    def __init__(self, stem, stem_pre, stages, num_classes=None, out_features=None):
        """
        Args:
...
def build_two_stem_resnet_backbone(cfg, input_shape):
    """
    ...
    return ResNet(stem, stem_pre, stages, out_features=out_features).freeze(freeze_at)
