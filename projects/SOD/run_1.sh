...
# process.
######################################################
CONFIG_FILE=${CURDIR}/configs/SOD_R_50_FPN_2x_no_base_pe_scale_variance_norm_loc_prior_ciou_001.yaml
GPU_NUM=8
OUTPUT_DIR=${CURDIR}/models/SOD_R_50_FPN_2x_no_base_pe_scale_variance_norm_loc_prior_ciou_001
HDFS_DIR=${HDFS_ROOT}/models/sod/SOD_R_50_FPN_2x_no_base_pe_scale_variance_norm_loc_prior_ciou_001
