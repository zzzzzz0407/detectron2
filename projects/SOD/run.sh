...
# process.
######################################################
CONFIG_FILE=${CURDIR}/configs/SOD_R_50_FPN_2x_no_base_sym_False_lr_0.001.yaml
GPU_NUM=8
OUTPUT_DIR=${CURDIR}/models/SOD_R_50_FPN_2x_no_base_sym_False_lr_0.001
HDFS_DIR=${HDFS_ROOT}/models/sod/SOD_R_50_FPN_2x_no_base_sym_False_lr_0.001
