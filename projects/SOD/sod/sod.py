...
class SOD(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.scale_normalize = cfg.MODEL.SOD.SCALE_NORMALIZE
        self.scale_coef = cfg.MODEL.SOD.SCALE_COEFF
        # fmt: on
        ...
        matcher = HungarianMatcher(
            ...
            loc_prior=cfg.MODEL.SOD.LOC_PRIOR,
            scale_variance=cfg.MODEL.SOD.SCALE_VARIANCE,
...
class SODInsHead(nn.Module):
    ...
    def rescale_and_cat(self, features):
        ...
        for l, ins_feat in enumerate(features):
            ...
            if self.max_pool:
                ins_feat = F.adaptive_max_pool2d(ins_feat, dst_size)
            else:
    ...
    def forward(self, ins_features, base_features=None):
        ...
        if self.rescale_first:
            ...
            tower_features = list()
            for ins_feat in ins_features:
                tower_features.append(self.ins_before_tower(ins_feat))
            ins_features = self.rescale_and_cat(tower_features)
